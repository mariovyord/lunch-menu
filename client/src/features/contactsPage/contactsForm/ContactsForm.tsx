	...
	return (
		<form className='text-base' onSubmit={handleSubmit}>
			...
			<div className='mt-2 px-2'>
				...
				<textarea className='border-2 rounded-lg w-full min-h-[125px] mt-2 p-2 text-black' name="message" id="message" placeholder='ex.: Hello, I love your ravioli!'></textarea>
			</div>
